...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> searchProducts(
        ...
        return ResponseEntity.ok(service.searchProductByKeywordAndMaxPrice(keyword, maxPrice));
    }
    ...
    public ResponseEntity<Void> updateStock(
            ...
            @RequestBody ProductDTO stockUpdate) {
        service.updateProductStock(id, stockUpdate.getStock());
        return ResponseEntity.noContent().build();
    }
